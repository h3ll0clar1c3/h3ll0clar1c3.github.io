...
A C program scripted and edited with the newly generated shellcode:
...
Expanding on the POC and the notion of AV evasion, a Bind TCP shellcode generated by Msfvenom was incorporated into the C code to test the result between the original (unobfuscted) and obfuscated shellcode binary analyzed on VirusTotal.
