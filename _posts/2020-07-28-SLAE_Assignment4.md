...
The execve-stack shellcode from the course material will be used as a reference for the shellcode in use, this shellcode will spawn a '''bash /bin/sh''' shell.
